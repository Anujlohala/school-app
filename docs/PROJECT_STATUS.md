...
| Member dashboard                     | Live integration implemented; awaiting user review | Responsive overview at `/dashboard` backed by the active cycle, current scheduled month, collection and payment status, winner and payout, saving breakdown, cycle progress, meeting countdown, latest contribution, and empty states | User review and production deployment verification                                                        |
